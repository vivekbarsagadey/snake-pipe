...
class APIExtractor:
    ...
    def extract_endpoint(self, endpoint: str, params: Optional[Dict[str, Any]] = None,
    ...
    def extract_paginated(self, endpoint: str, params: Optional[Dict[str, Any]] = None,
    ...
    def extract_to_dataframe(self, endpoint: str, **kwargs) -> pd.DataFrame:
        """
