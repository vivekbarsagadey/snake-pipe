...
class CSVExtractor:
    ...
    def extract_sample(self, n_rows: int = 100) -> pd.DataFrame:
        ...
        temp_extractor = CSVExtractor(str(self.file_path), **kwargs)
    ...
    def get_column_info(self) -> Dict[str, Any]:
        ...
        return {"columns": list(sample_df.columns), "dtypes": sample_df.dtypes.to_dict(), "shape": sample_df.shape, "null_counts": sample_df.isnull().sum().to_dict()}
