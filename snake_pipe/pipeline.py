...
from .extract import CSVExtractor, DatabaseExtractor, APIExtractor
from .transform import DataCleaner, DataValidator, DataEnricher
from .load import DatabaseLoader, FileLoader, WarehouseLoader
...
class Pipeline:
    ...
    def extract_from_csv(self, file_path: str, **kwargs) -> 'Pipeline':
        """
    ...
    def extract_from_database(self, query: str, connection_string: Optional[str] = None, 
                            **kwargs) -> 'Pipeline':
        """
    ...
    def extract_from_api(self, endpoint: str, base_url: Optional[str] = None,
                        api_key: Optional[str] = None, **kwargs) -> 'Pipeline':
        """
    ...
    def clean_data(self, **kwargs) -> 'Pipeline':
        """
    ...
    def validate_data(self, **kwargs) -> 'Pipeline':
        """
    ...
    def enrich_data(self, **kwargs) -> 'Pipeline':
        """
    ...
    def load_to_csv(self, filename: str, output_dir: Optional[str] = None, **kwargs) -> 'Pipeline':
        """
    ...
    def load_to_database(self, table_name: str, connection_string: Optional[str] = None,
                        **kwargs) -> 'Pipeline':
        """
    ...
    def apply_custom_transform(self, transform_func: Callable[[pd.DataFrame], pd.DataFrame],
                             description: str = "custom transform") -> 'Pipeline':
        """
...
def run_pipeline() -> None:
    ...
    try:
        ...
        result = (pipeline
                 .extract_from_csv("sample_data.csv")
                 .clean_data()
                 .load_to_csv("processed_data.csv")
                 .run())
