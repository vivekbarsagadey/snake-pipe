...
class DataCleaner:
    ...
    def handle_missing_values(self, strategy: str = "drop", columns: Optional[List[str]] = None, fill_value: Any = None) -> "DataCleaner":
        """
    ...
    def apply_custom_transform(self, func: Callable[[pd.DataFrame], pd.DataFrame], description: str = "custom transform") -> "DataCleaner":
        """
