...
class FileLoader:
    ...
    def load_csv(self, df: pd.DataFrame, filename: str, **kwargs: Any) -> str:
        """
    ...
    def load_excel(self, df: pd.DataFrame, filename: str, sheet_name: str = "Sheet1", **kwargs: Any) -> str:
        """
        ...
        try:
            ...
            excel_kwargs = {"index": False, "sheet_name": sheet_name}
    ...
    def load_parquet(self, df: pd.DataFrame, filename: str, **kwargs: Any) -> str:
        """
    ...
    def load_json(self, df: pd.DataFrame, filename: str, orient: str = "records", **kwargs: Any) -> str:
        """
        ...
        try:
            ...
            json_kwargs = {"orient": orient, "date_format": "iso", "indent": 2}
    ...
    def append_to_csv(self, df: pd.DataFrame, filename: str, **kwargs: Any) -> str:
        """
        ...
        try:
            ...
            csv_kwargs = {"mode": "a", "header": not file_path.exists(), "index": False, "encoding": "utf-8"}  # Add header only if file doesn't exist
            csv_kwargs.update(kwargs)
